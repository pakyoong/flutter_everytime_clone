...
import '../add_direct_page/add_direct_page.dart';
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        height: availableHeight * 0.04,
                        width: availableWidth * 0.185,
                        margin: EdgeInsets.only(
                          right: availableWidth * 0.045,
                        ),
                        decoration: BoxDecoration(
                          border: Border.all(
                            color: Theme.of(context).unselectedWidgetColor,
                            ...
                            if (dayOfWeekSnapshot.hasData) {
                              return StreamBuilder(
                                stream: widget.userBloc
                                    .currentSelectedClassTimetable!.classTimetableData,
