...
import 'package:everytime/ui/board_page/graduates_board_page/graduates_board_detail_page.dart';
import 'package:everytime/ui/board_page/graduates_board_page/graduates_board_write_page.dart';
import 'package:flutter/material.dart';

import 'package:cloud_firestore/cloud_firestore.dart';

class GraduatesBoard extends StatefulWidget {
  final PostBloc BoardBloc;
  const GraduatesBoard({super.key, required this.BoardBloc});

  @override
  State<GraduatesBoard> createState() => _GraduatesBoardState();
}

class _GraduatesBoardState extends State<GraduatesBoard> {
  late PostBloc graduatesBoardBloc = PostBloc();
  List<Post> postList = [];
  String boardId = 'Graduates';
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => GraduatesBoard(
            ...
            onSelected: (int item) async {
              if (item == 1) {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => GraduatesBoardWrite(
                            graduatesBoardBloc: graduatesBoardBloc,
                          )),
                );
              } else if (item == 3) {
                // 즐겨찾기 기능 보류
