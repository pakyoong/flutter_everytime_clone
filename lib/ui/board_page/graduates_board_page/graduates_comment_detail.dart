...
class GraduatesCommentDetail extends StatefulWidget {
  const GraduatesCommentDetail(
      {super.key, required this.post, required this.commentBloc});
  final Post post;
  final CommentBloc commentBloc;

  @override
  State<GraduatesCommentDetail> createState() => _GraduatesCommentDetailState(post: post);
}

class _GraduatesCommentDetailState extends State<GraduatesCommentDetail> {
  late Post post;
  late String postId;
  ...
  _GraduatesCommentDetailState({required this.post}) {
    postId = post.postId;
  }
  @override
  void initState() {
