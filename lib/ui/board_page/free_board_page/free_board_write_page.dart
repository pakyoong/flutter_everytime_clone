              ...
              onPressed: () async{
                ...
                if (title.trim().isEmpty || content.trim().isEmpty) {
                  ...
                  if (_selectedImage != null) {
                    await widget.freeBoardBloc.submitPostWithImage(boardId, _selectedImage!);
                  } else {
                    await widget.freeBoardBloc.submitPost(boardId);
                  }
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => FreeBoard(boardBloc: widget.freeBoardBloc),
                    ),
                  );
