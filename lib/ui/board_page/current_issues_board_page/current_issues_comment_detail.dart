...
class CurrentIssuesCommentDetail extends StatefulWidget {
  const CurrentIssuesCommentDetail(
      {super.key, required this.post, required this.commentBloc});
  final Post post;
  final CommentBloc commentBloc;

  @override
  State<CurrentIssuesCommentDetail> createState() => _CurrentIssuesCommentDetailState(post: post);
}

class _CurrentIssuesCommentDetailState extends State<CurrentIssuesCommentDetail> {
  late Post post;
  late String postId;
  late List<DocumentSnapshot> commentList = [];
  late List<String> commentIdList;
  String boardId = 'CurrentIssues';

  _CurrentIssuesCommentDetailState({required this.post}) {
