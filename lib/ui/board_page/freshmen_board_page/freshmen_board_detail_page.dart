...
import 'package:everytime/ui/board_page/freshmen_board_page/freshmen_comment_detail.dart';
import 'package:flutter/material.dart';

class FreshmenBoardDetail extends StatefulWidget {
  final Post post;

  const FreshmenBoardDetail({super.key, required this.post});

  @override
  State<FreshmenBoardDetail> createState() => _FreshmenBoardDetailState(post: post);
}
