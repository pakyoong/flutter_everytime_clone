...
class InfoCommentDetail extends StatefulWidget {
  const InfoCommentDetail(
      {super.key, required this.post, required this.commentBloc});
  final Post post;
  final CommentBloc commentBloc;

  @override
  State<InfoCommentDetail> createState() => _InfoCommentDetailState(post: post);
}

class _InfoCommentDetailState extends State<InfoCommentDetail> {
  late Post post;
  late String postId;
  ...
  _InfoCommentDetailState({required this.post}) {
    postId = post.postId; 
  }
  @override
  void initState() {
