...
import 'package:everytime/ui/board_page/info_board_page/info_comment_detail.dart';
import 'package:flutter/material.dart';

class InfoBoardDetail extends StatefulWidget {
  final Post post;

  const InfoBoardDetail({super.key, required this.post});

  @override
  State<InfoBoardDetail> createState() => _InfoBoardDetailState(post: post);
}
