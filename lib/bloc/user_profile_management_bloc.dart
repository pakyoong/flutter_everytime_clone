...
// 입력받은 학기 이름과 시간표 이름을 가진 시간표를 삭제하는 함수
  ...
  void initGradeCalTest() {
    ...
    getTerm(0).updateSubject(0, credit: 3, gradeType: Grade.aPlus);
    getTerm(0).updateSubject(1, credit: 2, gradeType: Grade.A);
    getTerm(0).updateSubject(2, credit: 3, gradeType: Grade.aPlus, isMajor: true);
    getTerm(0).updateSubject(3, credit: 1, gradeType: Grade.bPlus);
    getTerm(0).updateSubject(4, credit: 3, gradeType: Grade.aPlus, isMajor: true);
    getTerm(0).updateSubject(5, credit: 3, gradeType: Grade.aPlus);

    // 두 번째 학기의 각 과목별 성적 정보 설정
    getTerm(1).updateSubject(0, credit: 3, gradeType: Grade.aPlus);
    getTerm(1).updateSubject(1, credit: 1, gradeType: Grade.A);
    getTerm(1).updateSubject(2, credit: 1, gradeType: Grade.aPlus, isMajor: true);
    getTerm(1).updateSubject(3, credit: 2, gradeType: Grade.B);
    getTerm(1).updateSubject(4, credit: 3, gradeType: Grade.aPlus);
    getTerm(1).updateSubject(5, credit: 1, gradeType: Grade.A);
